	...
	mutateForFilters (spell) {
		...
		if (spell.miscTags) {
			spell.miscTags.forEach((element) => {
				switch (element) {
					case "THP":
						spell._fMisc.push("Grants Temporary Hit Points");
						break;
					case "SM":
						spell._fMisc.push("Summoning");
						break;
					case "BF":
						spell._fMisc.push("Has Battle Form");
						break;
				}
			});
		}
