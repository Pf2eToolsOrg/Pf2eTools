...
class PageFilterSpells extends PageFilter {
	...
	mutateForFilters (spell) {
		...
		spell._fSavingThrow = spell.savingThrow == null ? [] : spell.savingThrow.basic ? [Parser.savingThrowAbvToFull(spell.savingThrow.type), "Basic"] : [Parser.savingThrowAbvToFull(spell.savingThrow.type)];
