...
It will automatically replace the version in the files where it needs to be replaced, create a commit with the message `chore(version) bump` and create a tag (in the form `v1.2.3`) at the commit.  
